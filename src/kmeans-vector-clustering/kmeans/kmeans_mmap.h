...
void launch_kmeans_labeling(float *d_datapoints, int *d_clust_assn, float *d_centroids, int *d_clusterSizes, int N, int S, int TPB, int K, int dimension, cudaStream_t stream);
void launch_kmeans_update_center(float *d_datapoints, int *d_clust_assn, float *d_partial_centroids, int *d_partial_clust_sizes, int N, int S, int TPB, int K, int dimension, cudaStream_t stream);
