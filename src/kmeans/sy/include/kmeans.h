...
void launch_kmeans_update_center_chunk(float *d_datapoints, int *d_clust_assn, float *d_centroids, int *d_cluster_sizes, int N, int TPB, int K, int dimension, int chunkSize);
#ifdef __cplusplus
}
#endif
